            ...
            <div className="row">
                <div className="col-md-8 offset-md-2">
                    ...
                    <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item">
                            <strong>Generate Flashcard Sets:</strong> Need to quickly study before an exam? Generate flashcards using the Llama 3.2 large language model to create a set.
                        </li>
                    </ul>
